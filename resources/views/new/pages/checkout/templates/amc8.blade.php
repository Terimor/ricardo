...
@section('styles_checkout')
  <link
    href="{{ mix_cdn('assets/css/new/pages/checkout/templates/amc8.css') }}"
...
@section('scripts_checkout')
  <script
    src="{{ mix_cdn('assets/js/new/pages/checkout/templates/amc8.js') }}"
...
@section('content_checkout')
  <div class="amc8">
    @include('new.pages.checkout.templates.amc8.reviews')
    @include('new.pages.checkout.templates.amc8.yellow-line')
    <div class="main-content container">
      <div class="left-column">
        @include('new.pages.checkout.templates.amc8.left-column.users-online')
        @include('new.pages.checkout.templates.amc8.left-column.step1-title')
      ...
      <div class="right-column">
        ...
        <transition name="fade">
          <div v-if="form.payment_provider && form.payment_provider !== 'paypal'" class="form" ref="form">
            @include('new.pages.checkout.templates.amc8.right-column.step4-title')
            ...
            @include('new.pages.checkout.templates.amc8.right-column.step5-title')
            ...
            <template v-if="form.payment_provider === 'credit-card'">
              @include('new.pages.checkout.templates.amc8.right-column.step6-title')
        ...
        @include('new.pages.checkout.templates.amc8.right-column.guarantee')
      </div>
    </div>
    @include('new.pages.checkout.templates.amc8.question')
  </div>
@endsection
