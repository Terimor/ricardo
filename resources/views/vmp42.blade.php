            ...
            <template v-if="!selectedPlan">
                <section class="carousel-section">
                    <div class="container">
                        ...
                        >
                            <img class="lazy promo__carousel-img"
                                 data-src="https://static-backend.saratrkr.com/image_assets/technatic_1.png" alt="">
                            <img class="lazy promo__carousel-img"
                                 data-src="https://static-backend.saratrkr.com/image_assets/Best_Product.png" alt="">
                            <img class="lazy promo__carousel-img"
                                 data-src="https://static-backend.saratrkr.com/image_assets/Gadgetify_1.png" alt="">
                            <img class="lazy promo__carousel-img"
                                 data-src="https://static-backend.saratrkr.com/image_assets/NewYourToday_3.png" alt="">
                        </carousel>
                    </div>
                </section>
