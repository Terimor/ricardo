...
<head>
    ...
    @if (Request::is('checkout') || Route::is('upsells'))
        ...
        <script src="https://www.paypal.com/sdk/js?currency={{$PayPalCurrency}}&disable-card=visa,mastercard,amex&client-id={{!empty($setting['instant_payment_paypal_client_id']) ? $setting['instant_payment_paypal_client_id'] : ''}}"></script>
