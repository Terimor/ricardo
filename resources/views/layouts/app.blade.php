...
<head>
    ...
    @if (Request::is('checkout'))
        ...
        <script src="https://www.paypal.com/sdk/js?currency={{\Utils::getPayPalCurrencyCode()}}&disable-card=visa,mastercard,amex&client-id={{$setting['instant_payment_paypal_client_id']}}"></script>
